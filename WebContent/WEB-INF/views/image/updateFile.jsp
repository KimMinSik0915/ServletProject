...
// page에 대한 정보를 문자열로 받아 되돌아 가는 URL뒤에 정보로 붙여 사용한다.
String strPage = multi.getParameter("page");

String strPerPageNum = multi.getParameter("perPageNum");

// 넘겨 받은 정보 확인하기
System.out.println("updateFile.jsp [strNo] : " + strNo);
...
if(FileUtil.exist(deletePath + deleteFile)) {
	...
	System.out.println("updateFile.jsp [deleteFile.exist] : " + deleteFile + " 존재합니다.");
	
	FileUtil.remove(deletePath + deleteFile);	// 실질적으로 지우는 처리
