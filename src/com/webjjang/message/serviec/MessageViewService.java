...
public class MessageViewService implements Service {
	...
	public MessageViewService() {
		...
		System.out.println("MessageViewService.MessageViewService() : 생성완료");		// 서버가 시작될 떄 확인 안나올때 Init.init() 확인해보기
	...
	public void setDAO(Object dao) {		// object로 받을 수 있다.
		...
		System.out.println("MessageViewService.setDAO().dao : " + dao);	// 서버가 시작될때 확인한다.
	...
	public Object service(Object obj) throws Exception {
		...
		return dao.view(vo.getNo());	// dao.write()실행 후 결과를 리턴해 준다.
